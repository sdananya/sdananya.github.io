...
Character training is my favourite of these approaches and it has the similar problem. We are trying to give a model a stable self, but the "self" of a language model is kinda a pile of personas it absorbed from pretraining, and point 4 tells us how easily that pile gets shoved around. A character can drift or flip under a long enough roleplay or a weird enough prompt. It's the most promising direction to me (but like what character do we even want?).

## Section IV: So is it solvable?

This is the question I started with and I think the answer is "depends what you mean by solved". Yea, kinda annoying I know.
